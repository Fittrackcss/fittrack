...
const mockHealthTips = [
  { id: "1", title: 'Stay Hydrated', description: 'Drink at least 8s of water daily to maintain optimal health and energy levels.', category: 'Hydration', icon: 'water' },
  { id: "2", title: 'Get Enough Sleep', description: 'Aim for 7-9s of quality sleep each night to support recovery and mental health.', category: 'Sleep', icon: 'bed' },
  { id: "3", title: 'Eat More Protein', description: 'Include lean protein sources in every meal to support muscle growth and repair.', category: 'Nutrition', icon: 'nutrition' },
  { id: "4", title: 'Move Daily', description: 'Even 30 minutes of moderate exercise daily can significantly improve your health.', category: 'Exercise', icon: 'fitness' },
  { id: "5", title: 'Practice Mindfulness', description: 'Take 10 minutes daily for meditation or deep breathing to reduce stress.', category: 'Mental Health', icon: 'brain' }
];
