...
function makeStyles(colors) {
  return StyleSheet.create({
    ...
    settingRow: {
      flexDirection: "row", alignItems: "center", justifyContent: "space-between",
      backgroundColor: colors.background.card, borderRadius: 10, padding: 16, marginBottom: 12,
      shadowColor: "#7F9497", shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.08, shadowRadius: 4, elevation: 2,
    },
    ...
    actionCard: {
      ...
      borderRadius: 10, padding: 16, marginBottom: 12, gap: 10,
      shadowColor: "#7F9497", shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.08, shadowRadius: 4, elevation: 2,
    },
